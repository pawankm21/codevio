...
export default function Console() {
  ...
  return <div className="text-white bg-neutral-800 rounded  w-full absolute "
  
  >
    <div className="w-full flex place-items-center p text-neutral-300-5 border-t border-neutral-400 justify-center gap-4 ">
    ...
    >
      <div className="grid grid-cols-2 gap-4 h-[30vh]">
        ...
        <div className="col-span-1 bg-black text-neutral-300 m-4 p-2">
          ...
          <div className="overflow-auto scrollbar-hide" ref={consoleRef}>
